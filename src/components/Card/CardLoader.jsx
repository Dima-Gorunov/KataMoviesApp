    ...
    return (
      <div className="movie-card-container">
        <div className="movie-card__image-container">
          <img src={defImage} alt="Movie Poster" />
        </div>
        <div className="movie-card">
          <div className="movie-card__title-container">
            <div className="movie-card__title">loading...</div>
            <div className="movie-card__release-date">loading...</div>
            <div className="movie-card__genres-container">loading...</div>
          </div>
          <div className="movie-card__description">loading...</div>
